...
**Requires:** The SpriteCook Codex plugin or another editor setup that connects the SpriteCook MCP server. For non-plugin setups, use `npx spritecook-mcp setup` or see [spritecook.ai](https://spritecook.ai).
